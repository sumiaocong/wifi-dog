...
#define DEFAULT_CONFIGFILE "/tmp/wifidog.conf"
#define DEFAULT_HTMLMSGFILE "/tmp/wifidog-msg.html"
...
#define DEFAULT_AUTHSERVROAMPATHFRAGMENT "roam/?"
...
typedef struct _auth_serv_t {
	...
	//added by chengang@20210317
	char *authserv_roam_script_path_fragment;
...
typedef struct {
	...
	t_trusted_mac *roamedmaclist; /**< @brief list of roamed macs */
